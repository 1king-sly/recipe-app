...
final List<Recipe> recipes = [
  Recipe(
    ...
    time: '10 mins',
    user: RecipeOwner(name: 'Alice', imagePath: 'assets/images/user.jpg'),
    images: ['assets/images/mojito1.jpg', 'assets/images/mojito2.jpg'],
  ...
  Recipe(
    ...
    time: '20 mins',
    user: RecipeOwner(name: 'Charlie', imagePath: 'assets/images/user.jpg'),
    images: ['assets/images/pancake1.jpg', 'assets/images/pancake2.jpg'],
  ...
  Recipe(
    ...
    time: '30 mins',
    user: RecipeOwner(name: 'Fiona', imagePath: 'assets/images/user.jpg'),
    images: ['assets/images/tomatosoup1.jpg', 'assets/images/tomatosoup2.jpg'],
  ...
  Recipe(
    ...
    time: '20 mins',
    user: RecipeOwner(name: 'Jack', imagePath: 'assets/images/user.jpg'),
    images: ['assets/images/fishtacos1.jpg', 'assets/images/fishtacos2.jpg'],
